...
//          }
            if (h.pageTabs) {
                ...
                if (!u) {
                    if ((h.mTabList.length + 1) >= h.maxTabNum) {
                        r.msg("最多打开" + h.maxTabNum + "个选项卡", {icon: 2});
        ...
        loadHome: function (v) {
            ...
            h.loadView({menuPath: c, menuName: v.menuName});
            if (!h.pageTabs) {
        ...
        openTab: function (v) {
            ...
            h.loadView({menuPath: t, menuName: u})
        },
        closeTab: function (t) {
            if (window != top && !m.isTop()) {
                if (top.layui && top.layui.index) {
        ...
        setTabCache: function (t) {
            ...
            layui.data(m.tableName, {key: "cacheTab", value: t});
            h.cacheTab = t;
            if (t) {
                m.putTempData("indexTabs", h.mTabList);
                m.putTempData("tabPosition", h.mTabPosition)
